...
public class Scenario_Login_Component_Reference {
	
	@Test(dataProvider="dp_Invalid_Login",dataProviderClass=Framework.DataProvider_Login_Component.class)
	...
	@Test(dataProvider="dp_Valid_Login",dataProviderClass=Framework.DataProvider_Login_Component.class)
